...
public class S3CleanUp {
    ...
    public S3CleanUp(S3Client s3Client, HomeSliderImageRepository homeSliderImageRepository, ProductDetailImageRepository productDetailImageRepository, ProductImageRepository productImageRepository, CommunityImageRepository communityImageRepository) {
    ...
    public void cleanupUnusedS3Files() {
        ...
        try {
            ...
            communityImageRepository.findAll().forEach(image -> {
                String fileName = extractFileNameFromPath(image.getImageUrl());
                dbImageFileNames.add(fileName);
            });
